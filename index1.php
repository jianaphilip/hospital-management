...
<html lang="en">
  ...
  <body style="background:-webkit-linear-gradient(left, #FFD3A5, #FD6585); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp BURJEEL HOSPITALS</h4></a>
    ...
    animation: mover 1s infinite alternate;">
          <img src="TCPDF/doctor.jpg" alt="" style="width: 20%;padding-left: 40px;margin-top: 150px;margin-left: 45px;margin-bottom:15px">
      </div>
